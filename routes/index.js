...
router.get('/', function(req, res) {
  res.render('index', { title: 'fruitjuice Items App', user:req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'fruitjuice Items App Registration'});
  });
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'fruitjuice App Login', user : req.user });
});
